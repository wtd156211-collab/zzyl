...
public class QianfanAIModelTest {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        OpenAIClient client = OpenAIOkHttpClient.builder()
                .apiKey("bce-v3/ALTAK-Y9qmxsO3O8VYsoF0wkwDk/1b0a1ea09ad1097e4e00eefe128febc451473324") //将your_APIKey替换为真实值，如何获取API Key请查看https://cloud.baidu.com/doc/WENXINWORKSHOP/s/Um2wxbaps#步骤二-获取api-key
