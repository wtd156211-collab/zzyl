...
public class NursingPlanController extends BaseController
{
    ...
    @PostMapping("/export")
    public void export(@ApiParam("护理计划导出的查询条件对象") HttpServletResponse response, NursingPlan nursingPlan)
    {
        List<NursingPlan> list = nursingPlanService.selectNursingPlanList(nursingPlan);
    ...
    @PostMapping
    public AjaxResult add(@RequestBody @ApiParam("新增的护理计划对象") NursingPlanDto nursingPlanDto)
    {
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody @ApiParam("修改的护理计划对象") NursingPlanDto nursingPlanDto)
    {
